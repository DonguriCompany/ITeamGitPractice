...
<body>
	...
	<div class="container">
		<div class="card">
			<h5 class="card-title center-align">イベントの編集が完了しました</h5>

			<div class="event-details">
				<h6>
					<strong>編集後のイベント情報</strong>
				</h6>
				<p>
					<strong>タイトル:</strong> ${event.title}
				</p>
				<p>
					<strong>日時:</strong> ${formattedDateTime}
				</p>
				<p>
			...
			<div class="center-align">
				<a href="/event-detail/${event.id}"
					class="btn waves-effect waves-light teal lighten-2">イベント詳細へ戻る</a> <a
					href="/home" class="btn waves-effect waves-light teal">ホームへ戻る</a>
			</div>
		</div>
	</div>
